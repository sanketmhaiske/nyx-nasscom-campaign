...
const performanceData = [
  { name: 'Jan', spend: 1200, ctr: 2.4, conversions: 450 },
  { name: 'Feb', spend: 1400, ctr: 2.8, conversions: 520 },
  { name: 'Mar', spend: 1100, ctr: 2.2, conversions: 480 },
  { name: 'Apr', spend: 1500, ctr: 3.0, conversions: 580 },
  { name: 'May', spend: 1650, ctr: 3.2, conversions: 620 },
  { name: 'Jun', spend: 1480, ctr: 2.9, conversions: 550 },
];
const performanceData2 = [
  { name: 'Jan', spend: 1500, ctr: 2.4, conversions: 900 },
  { name: 'Feb', spend: 1100, ctr: 2.8, conversions: 590 },
  { name: 'Mar', spend: 1600, ctr: 2.2, conversions: 560 },
  { name: 'Apr', spend: 1400, ctr: 3.0, conversions: 980 },
  { name: 'May', spend: 1950, ctr: 3.2, conversions: 530 },
  { name: 'Jun', spend: 1280, ctr: 2.9, conversions: 590 },
];
const performanceData3 = [
  { name: 'Jan', spend: 1400, ctr: 2.4, conversions: 350 },
  { name: 'Feb', spend: 1500, ctr: 2.8, conversions: 420 },
  { name: 'Mar', spend: 1200, ctr: 2.2, conversions: 580 },
  { name: 'Apr', spend: 1900, ctr: 3.0, conversions: 680 },
  { name: 'May', spend: 1150, ctr: 3.2, conversions: 720 },
  { name: 'Jun', spend: 1680, ctr: 2.9, conversions: 850 },
];
...
export default function Dashboard() {
  ...
  const [pData, setPData] = useState(performanceData)
              ...
              <CardContent className="p-6">
                <div className="flex justify-end mb-4">
                  <div className="flex gap-2">
                    <button
                      onClick={() => setPData(performanceData)}
                      className={cn(
                        "px-3 py-1.5 text-sm rounded-lg transition-all duration-200",
                        `${pData === performanceData ? 'bg-gradient-to-r' : "bg-[#2D1B69]/30"} from-[#6D28D9] to-[#4F46E5] text-white hover:from-[#5B21B6] hover:to-[#4338CA]`
                      )}>Daily</button>
                    <button
                      onClick={() => setPData(performanceData2)}
                      className={cn(
                        "px-3 py-1.5 text-sm rounded-lg transition-all duration-200",
                        ` ${pData === performanceData2 ? 'bg-gradient-to-r' : "bg-[#2D1B69]/30"} from-[#6D28D9] to-[#4F46E5] text-white  hover:bg-[#2D1B69]/50`
                      )}>Weekly</button>
                    <button
                      onClick={() => setPData(performanceData3)}
                      className={cn(
                        "px-3 py-1.5 text-sm rounded-lg transition-all duration-200",
                        `${pData === performanceData3 ? 'bg-gradient-to-r' : "bg-[#2D1B69]/30"} from-[#6D28D9] to-[#4F46E5] text-white hover:bg-[#2D1B69]/50`
                          ...
                          <div className="flex flex-wrap gap-3 justify-center mt-8">
                            {payload?.map((entry: any) => (
                              ...
                              >
                                ...
                                <div
                                  className={`w-3 h-3 rounded-full ${!selectedMetrics.includes(String(entry.dataKey)) ? 'opacity-40' : ''
                                    }`}
                                  style={{
