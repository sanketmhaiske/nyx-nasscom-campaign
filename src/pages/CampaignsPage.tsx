...
const genCampaigns = JSON.parse(localStorage.getItem('campaign_names') || '[]');

const initialCampaigns: CampaignState[] = [
  {
    id: 1,
    name: genCampaigns[0] ?? "NYX_Trent_Fall2025_India_Female18to64_QuickConvenience",
  ...
  {
    id: 2,
    name: genCampaigns[1] ?? "NYX_Trent_Fall2025_India_AllAges_QuickConvenience",
  ...
  {
    id: 3,
    name: genCampaigns[2] ?? "NYX_Trent_Fall2025_India_newLaunch_Ceremony",
    status: "active" as const,
